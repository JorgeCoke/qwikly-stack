...
export const Input = component$<FormProps>((props: any) => {
  ...
  return (
    <div class={twMerge("inline-flex w-full flex-col gap-1 py-2", ...classes)}>
      ...
      <input
        {...props}
        class="grow rounded-md bg-white p-2 text-slate-800 ring-1 ring-inset ring-slate-300 dark:bg-slate-950 dark:text-slate-200 dark:ring-slate-800"
      />
      {props.description && (
...
export const Select = component$<SelectProps>((props: any) => {
  ...
  return (
    <div class={twMerge("inline-flex w-full flex-col gap-1 py-2", ...classes)}>
      ...
      <select
        {...props}
        class="block w-full rounded-md bg-white p-2 text-slate-800 ring-1 ring-inset ring-slate-300 dark:bg-slate-950 dark:text-slate-200 dark:ring-slate-800 "
      >
  ...
  return (
    <div class={twMerge("inline-flex w-full flex-col gap-1 py-2", ...classes)}>
      ...
      <div class="flex">
        <input
          {...props}
          class="grow rounded-md rounded-r-none bg-white px-2 text-slate-800 ring-1 ring-inset ring-slate-300 dark:bg-slate-950 dark:text-slate-200 dark:ring-slate-800"
        />
